...
CNPC Wizards Integration (Unofficial) is an independent compatibility project. This repository does not include third-party mod source code, assets, game files, mod JARs, client packs, server packs, or world data.

The following names and identifiers appear because the project was designed to interoperate with them:

| Project or component | Role in this repository | License information observed for the development versions |
|---|---|---|
...
| Elemental Wizards RPG | Optional runtime spell content | All Rights Reserved in the development artifact metadata |
| CustomNPCs unofficial Fabric build | Optional NPC scripting and UI integration | CC BY-NC in the development artifact metadata |
